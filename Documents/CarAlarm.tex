...
\begin{document}
	...
	\title{
		\includegraphics[width=0.5\textwidth]{resources/quctLogo.pdf}\\[8ex]
		\XBT
			سیستم دزدگیر خودرو
	}
	\author{
	...
	این پروژه به منظور پیاده سازی یک سیستم دزدگیر ماشین است.
	...
	viper
	موجود در
	\hyperref{https://play.google.com/store/apps/details?id=com.directed.android.viper&hl=en&gl=US}{car alarm application}{Viper 5906V}{فروشگاه \lr{play}}
	که در
	...
	$49.95\$$
	فروشگاه
	\hyperref{https://www.amazon.com/gp/product/B00U0K3Q10/ref=as_li_tl?ie=UTF8&tag=eastcoastje03-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=B00U0K3Q10&linkId=0d3d80c6869fc7dfbc5d6ccec21c2e97}{car alarm}{carlock}{\lr{amazon}}
	به فروش می‌رسد.
	...
	\subsection{
		\lr{Qt/C++}}\label{subsec1:sec5:chap1}
		فریم‌ورک
...
%	\begin{enumerate}[nosep]\label{enum1:sec0:chap0}
%		\item
%	\end{enumerate}
%
%	\begin{table}[!h]
